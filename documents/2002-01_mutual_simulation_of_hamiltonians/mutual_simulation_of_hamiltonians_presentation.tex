...
\vfill
\begin{center}
{\Large \blue Mutual simulation of Hamiltonian dynamics\\ on $n$
interacting quantum systems} 

\vfill Pawel Wocjan, Dominik Janzing, Martin R"otteler, and Thomas Beth

{\small Institut f"ur Algorithmen und Kognitive Systeme}

{\small Universit"at Karlsruhe, Germany}
\end{center}
\vfill
\end{slide}
