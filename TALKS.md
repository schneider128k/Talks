...
- **Quantum Algorithm for Computing the Period Lattice of an Infrastructure** —
  *Seminar and invited talks*, October 2011 – April 2013  
  ...
  Somma; and at the third Heilbronn Quantum Algorithms Day, University of Bristol, 25 April
  2013, at the invitation of Steve Brierley. All three sets of slides are here.  
  Joint work with Felix Fontein.  
  The talk is built on [arXiv:1111.1348](https://arxiv.org/abs/1111.1348) and
...
- **Speed-up via Quantum Sampling** — *Seminar*, 29 April 2008  
  ...
  Joint work with Anura Abeyesinghe.  
  I gave this one at the blackboard. I still have the handwritten notes and plan to scan
  them in.  
  The talk is built on [arXiv:0804.4259](https://arxiv.org/abs/0804.4259).
...
- **Classical Problems Characterizing the Power of Quantum Computing** — *Invited talk*,
  ...
  The *Conclusions* slide carries only its title.  
  ...
  The slides here are the finished deck of the evening of 3 November 2007. The source beside
  them no longer reproduces it under a current LaTeX, so the PDF was made from the compiled
  output of that evening, which is here as well.  
